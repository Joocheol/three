...
가장 이해하기 쉬운 거래는 \textbf{사다}와 \textbf{팔다}가 동시에 일어나는 형태입니다. 이 형태의 거래는 \textbf{주다(pay)}와 \textbf{받다(receive)}가 동시에 일어나는 것으로 해석할 수 있습니다.
...
\begin{center}\includegraphics[width=1\linewidth]{three_files/figure-latex/unnamed-chunk-2-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{three_files/figure-latex/unnamed-chunk-3-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{three_files/figure-latex/unnamed-chunk-8-1} \end{center}
