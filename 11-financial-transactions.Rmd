...
```{tikz, fig.cap="현재시점에 돈을 주다를 표시하는 방법입니다. 시점은 0입니다. 화살표는 아래쪽으로 그려져 있습니다.", fig.align="center", echo=FALSE}
...
\end{tikzpicture}
```
위의 그림이 현재시점에 일정 금액을 **주다**를 표시하는 방법이다. 시점은 0입니다. 화살표는 아래쪽으로 그려져 있습니다. 아래쪽은 내 주머니에서 무엇인가가 나가는 것을 의미합니다.  
